...
public class MainActivity extends AppCompatActivity
    ...
    public String contact = "pahka@gmail.com";
    public String tel = "+79145733204";
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camara) {
            ...
            Intent emailIntent = new Intent(Intent.ACTION_SENDTO, Uri.fromParts(
                    "mailto","abc@gmail.com", null));//наш емейл адрес
           ...
           Intent smsIntent = new Intent(Intent.ACTION_VIEW);
            ...
            smsIntent.putExtra("sms_body", "смс текст");//текс смс

            smsIntent.putExtra("address", tel);//телефон на который отправляеться смс.
                                               // public String tel = "+79145733205";
            ...
            Uri address = Uri.parse("http://keke.su");
